...
// **HINT! The output of THIS code, at least, will only run when you click over to the "Shell" tab over to the right of this window, above the "console" window and next to the "console" tab. If you don't see it, try clicking the "+" sign to the right of the "console" tab and select it from there. Then, type "node index.js" to run your index.js in the shell and see the outputs of your code! Congrats, btw - this is your first brush with Node.JS, the backend, server-side version of JavaScript!
